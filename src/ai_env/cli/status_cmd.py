...
def status() -> None:
    ...
    codex_target_dir = Path.home() / ".codex"
    codex_items = [
        ("AGENTS.md", global_dir / "CLAUDE.md", codex_target_dir / "AGENTS.md"),
    ...
    table4 = _create_table(
        title="Codex Global Config (ai-env → ~/.codex)",
        columns=[("Item", "cyan"), ("Source (ai-env)", "yellow"), ("Target (~/.codex)", "green")],
        rows=codex_rows,
    )
