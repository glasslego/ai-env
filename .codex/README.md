...
## 프로젝트별 Claude skills 공유

현재 프로젝트의 Claude 자산을 Codex와 같이 쓰려면:

```bash
uv run ai-env project sync-codex
```

이 명령은 기본적으로 다음을 만든다.

- `./AGENTS.md` → `./CLAUDE.md` (기본: 심볼릭 링크)
- `./.codex/skills` → `./.claude/skills` 기반 정규화 복사본
