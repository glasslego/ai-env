...
class TestNotionCleaner:
    ...
    def test_remove_notion_id_from_title(self):
        ...
        assert cleaner.remove_notion_id_from_title(
            "spark 튜닝 a4405ba1e3e5833da2d30149003acead"
        ) == "spark 튜닝"
        ...
        assert cleaner.remove_notion_id_from_title(
            "file 9b305ba1e3e582c9aa2f8121ac069c86.md"
        ) == "file"
...
"""
    ...
    def test_clean_folder_name(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert converter._clean_folder_name(
